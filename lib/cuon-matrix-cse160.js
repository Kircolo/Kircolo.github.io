...
class Vector3 {
    ...
    magnitude() {
        ...
        let m = Math.sqrt(element1 + element2 + element3); // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let m = this.magnitude(); // Modify this line to calculate this vector's magnitude.
        if (m === 0) { return this; } // div by zero check
        this.elements[0] /= m;
        this.elements[1] /= m;
        this.elements[2] /= m;
        // Don't delete the return statement.
